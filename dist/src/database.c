...
sh_int gsn_lore;
sh_int gsn_elem_lore;
sh_int gsn_magic_lore;
sh_int gsn_weapon_lore;
sh_int gsn_armor_lore;
sh_int gsn_force_lore;
sh_int gsn_forest_lore;
sh_int gsn_map_lore;
...
sh_int gsn_flaming_arrow;
sh_int gsn_barbed_arrow;
sh_int gsn_shadow_arrow;
sh_int gsn_piercing_arrow;
sh_int gsn_camouflaged_arrow;
sh_int gsn_dodge_craft;
...
sh_int gsn_fast_healing2;
sh_int gsn_fast_healing3;
sh_int gsn_fast_healing4;
sh_int gsn_fast_healing5;
sh_int gsn_meditation;
sh_int gsn_meditation2;
sh_int gsn_meditation3;
sh_int gsn_meditation4;
sh_int gsn_meditation5;
sh_int gsn_heal_ii;
sh_int gsn_heal_iii;
sh_int gsn_heal_iv;
sh_int gsn_heal_v;
sh_int gsn_steal;
sh_int gsn_heighten;
sh_int gsn_force_throw;
sh_int gsn_force_push;
sh_int gsn_gouge;
...
sh_int gsn_tachi_kashi;
sh_int gsn_tachi_jinpu;
sh_int gsn_tachi_gekko;
sh_int gsn_tachi_enpi;
sh_int gsn_tachi_koki;
sh_int gsn_tachi_haboku;
sh_int gsn_tachi_kagero;

sh_int gsn_makepotion;
sh_int gsn_throw;
sh_int gsn_kick;
sh_int gsn_firekick;
sh_int gsn_icekick;
...
sh_int gsn_fclaw;
sh_int gsn_clight;
sh_int gsn_cureplague;
sh_int gsn_remcurse;
sh_int gsn_niaver;
sh_int gsn_kyahu;

sh_int gsn_hadesarmor;
sh_int gsn_armor;
sh_int gsn_protect;
sh_int gsn_bless;
sh_int gsn_frenzy;
...
sh_int gsn_battleplan;
sh_int gsn_quickness;
...
void load_resetmsg args( ( AREA_DATA * tarea, FILE * fp ) );
...
void init_mysql( const char *mysqldb )
{
   ...
   {
      log_string( "FAILED TO CONNECT TO MYSQL" );
      kill_mysql(  );
      exit( 1 );
   }
   else
   {
      sprintf( buf, "MySQL connection established with %s, using MySQL C API library %s.",
               mysql_get_host_info( &mysql ), mysql_get_client_info(  ) );
      log_string( buf );
   }
   if( mysql_select_db( &mysql, mysqldb ) )
   {
   ...
   {
      sprintf( buf, "MySQL Server %s using database: %s", mysql_get_server_info( &mysql ), mysqldb );
      log_string( buf );
   }
}
...
void kill_mysql(  )
{
   log_string( "Closing MySQL Connection." );
   mysql_close( &mysql );
}
...
void mysql_keep_alive(  )
{
   ...
   {
      sprintf( buf2, "MySQL Server returned error on ping: %s", mysql_error( &mysql ) );
      log_string( buf2 );
   }
}
#endif
...
void boot_db( bool fCopyOver )
{
   ...
   sysdata.read_all_mail = LEVEL_BUILD;
   sysdata.read_mail_free = LEVEL_IMMORTAL;
   sysdata.write_mail_free = LEVEL_IMMORTAL;
   sysdata.take_others_mail = LEVEL_BUILD;
   sysdata.imc_mail_vnum = 0;
   sysdata.muse_level = LEVEL_BUILD;
   sysdata.think_level = LEVEL_HIGOD;
   sysdata.build_level = LEVEL_BUILD;
   sysdata.log_level = LEVEL_ADVBUILD;
   sysdata.level_modify_proto = LEVEL_BUILD;
   sysdata.level_override_private = LEVEL_HEADBUILD;
   sysdata.level_mset_player = LEVEL_BUILD;
   sysdata.stun_plr_vs_plr = 65;
   sysdata.lastcommand = STRALLOC( "" );
   sysdata.rname = STRALLOC( "" );
   sysdata.stun_regular = 15;
   sysdata.mset_auto = 1;
   sysdata.imp = 1;
   sysdata.impmsg = STRALLOC( "" );
   sysdata.dsq = 1;
   sysdata.kaura = 0;
   sysdata.exp1 = 6;
   sysdata.exp2 = 9;
   ...
   sysdata.debug = 0;
   sysdata.manualb = 0;
   sysdata.salltime = ctime( &current_time );
   sysdata.cver = 1;
   sysdata.immune_to_idle = 300;
   sysdata.trans_lock = 0;
   sysdata.fight_lock = 0;
   sysdata.pkill_lock = 0;
   sysdata.spell_lock = 0;
   sysdata.gouge_nontank = 0;
   sysdata.gouge_plr_vs_plr = 0;
   sysdata.bash_nontank = 0;
   sysdata.bash_plr_vs_plr = 0;
   sysdata.dodge_mod = 2;
   sysdata.max_hp = 1000000;
   sysdata.max_mana = 1000000;
   sysdata.max_move = 1000000;
   sysdata.max_prac = 10000;
   sysdata.max_glory = 10000;
   sysdata.parry_mod = 2;
   ...
   sysdata.level_getobjnotake = LEVEL_BUILD;
   sysdata.save_frequency = 20;
   ...
   sysdata.profanityfilter = TRUE;
   sysdata.showhitgains = FALSE;
...
*/
...

   {
      ...
      ASSIGN_GSN( gsn_shapeshift, "stormshift" );

      ASSIGN_GSN( gsn_lore, "lore" );
      ASSIGN_GSN( gsn_elem_lore, "song lore" );
      ASSIGN_GSN( gsn_magic_lore, "magic lore" );
      ASSIGN_GSN( gsn_weapon_lore, "weapon lore" );
      ASSIGN_GSN( gsn_armor_lore, "armor lore" );
      ASSIGN_GSN( gsn_force_lore, "force lore" );
      ASSIGN_GSN( gsn_forest_lore, "forest lore" );
      ASSIGN_GSN( gsn_map_lore, "map lore" );

      ASSIGN_GSN( gsn_clight, "continual light" );
      ASSIGN_GSN( gsn_cureplague, "cure plague" );
      ASSIGN_GSN( gsn_remcurse, "remove curse" );
      ASSIGN_GSN( gsn_niaver, "niaver" );

      ASSIGN_GSN( gsn_makepotion, "makepotion" );
      ASSIGN_GSN( gsn_hadesarmor, "hades armor" );
      ASSIGN_GSN( gsn_armor, "armor" );
      ASSIGN_GSN( gsn_protect, "protect" );
      ASSIGN_GSN( gsn_bless, "bless" );
      ASSIGN_GSN( gsn_frenzy, "frenzy" );
      ASSIGN_GSN( gsn_sanctuary, "sanctuary" );
      ASSIGN_GSN( gsn_calcify, "calcify flesh" );
      ASSIGN_GSN( gsn_displacement, "displacement" );
      ASSIGN_GSN( gsn_passdoor, "pass door" );
      ASSIGN_GSN( gsn_flying, "fly" );
      ASSIGN_GSN( gsn_fireshield, "fireshield" );
      ASSIGN_GSN( gsn_iceshield, "iceshield" );
      ASSIGN_GSN( gsn_shockshield, "shockshield" );
      ASSIGN_GSN( gsn_biofeedback, "biofeedback" );
      ASSIGN_GSN( gsn_battleplan, "battle plan" );
      ASSIGN_GSN( gsn_quickness, "quickness" );

      ASSIGN_GSN( gsn_flaming_arrow, "flaming arrow" );
      ASSIGN_GSN( gsn_barbed_arrow, "barbed arrow" );
      ASSIGN_GSN( gsn_shadow_arrow, "shadow arrow" );
      ASSIGN_GSN( gsn_piercing_arrow, "piercing arrow" );
      ASSIGN_GSN( gsn_camouflaged_arrow, "camouflaged arrow" );
      ASSIGN_GSN( gsn_dodge_craft, "dodgecraft" );

      ASSIGN_GSN( gsn_fclaw, "ferralclaw" );
      ASSIGN_GSN( gsn_kyahu, "kyahu" );
      ASSIGN_GSN( gsn_swords, "swords" );
      ASSIGN_GSN( gsn_katana, "katana" );
      ...
      ASSIGN_GSN( gsn_energy, "energy weapons" );
      ...
      ASSIGN_GSN( gsn_fast_healing2, "fast healing ii" );
      ASSIGN_GSN( gsn_fast_healing3, "fast healing iii" );
      ASSIGN_GSN( gsn_fast_healing4, "fast healing iv" );
      ASSIGN_GSN( gsn_fast_healing5, "fast healing v" );
      ASSIGN_GSN( gsn_meditation, "meditation" );
      ASSIGN_GSN( gsn_meditation2, "meditation ii" );
      ASSIGN_GSN( gsn_meditation3, "meditation iii" );
      ASSIGN_GSN( gsn_meditation4, "meditation iv" );
      ASSIGN_GSN( gsn_meditation5, "meditation v" );
      ASSIGN_GSN( gsn_steal, "steal" );
      ASSIGN_GSN( gsn_heighten, "heighten" );
      ASSIGN_GSN( gsn_force_throw, "forcethrow" );
      ASSIGN_GSN( gsn_force_push, "forcepush" );
      ...
      ASSIGN_GSN( gsn_godspell, "godspell" );
      ASSIGN_GSN( gsn_kick, "kick" );
      ASSIGN_GSN( gsn_throw, "throw" );

      ASSIGN_GSN( gsn_tachi_kashi, "tachikashi" );
      ASSIGN_GSN( gsn_tachi_jinpu, "tachijinpu" );
      ASSIGN_GSN( gsn_tachi_gekko, "tachigekko" );
      ASSIGN_GSN( gsn_tachi_enpi, "tachienpi" );
      ASSIGN_GSN( gsn_tachi_koki, "tachikoki" );
      ASSIGN_GSN( gsn_tachi_haboku, "tachihaboku" );
      ASSIGN_GSN( gsn_tachi_kagero, "tachikagero" );

      ASSIGN_GSN( gsn_firekick, "firekick" );
      ASSIGN_GSN( gsn_icekick, "icekick" );
      ASSIGN_GSN( gsn_lightningkick, "lightningkick" );
      ...
      ASSIGN_GSN( gsn_de, "detect evil" );
      ASSIGN_GSN( gsn_di, "detect invis" );
      ASSIGN_GSN( gsn_dh, "detect hidden" );
      ASSIGN_GSN( gsn_dm, "detect magic" );
      ASSIGN_GSN( gsn_dt, "detect traps" );
      ASSIGN_GSN( gsn_if, "infravision" );
      ASSIGN_GSN( gsn_sc, "scry" );
      ASSIGN_GSN( gsn_ts, "true sight" );

      ASSIGN_GSN( gsn_heal_ii, "heal ii" );
      ASSIGN_GSN( gsn_heal_iii, "heal iii" );
      ASSIGN_GSN( gsn_heal_iv, "heal iv" );
      ASSIGN_GSN( gsn_heal_v, "heal v" );
   }
...
/*        log_string( "Loading storerooms" );
      ...
      if( fCopyOver )
      {
         log_string( "Running warmboot_recover." );
         copyover_recover(  );
      }
   }
...
void load_plane( AREA_DATA * tarea, FILE * fp )
{
   if( !tarea )
   {
...
// int tmpgold = 0;
      ...
      pMobIndex->exptier = fread_number( fp );
...
/*	if (area_version <= 2)
	{
		...
		pMobIndex->silver = tmpgold/1000;
		tmpgold=tmpgold%1000;	
...
// }
      ...
      if( pMobIndex->sex > 1 )
      {
         pMobIndex->sex = number_range( 0, 1 );
      }
      ...
      {
         pMobIndex->perm_str = 15;
         pMobIndex->perm_dex = 15;
         pMobIndex->perm_int = 15;
         pMobIndex->perm_wis = 15;
         pMobIndex->perm_cha = 15;
         pMobIndex->perm_con = 15;
         pMobIndex->perm_lck = 15;
         pMobIndex->race = 0;
         pMobIndex->class = 3;
         pMobIndex->xflags = 0;
...
*/
      if( sysdata.imp == 1 )
      {
         if( pArea->age >= reset_age - 2 )
         {
            ...
            {
               separate_obj( obj );
               if( obj->in_room && ( obj->in_room->area == pArea )
                   //&& !xIS_SET(obj->extra_flags, ITEM_NOIMP) 
                   && !IS_OBJ_STAT( obj, ITEM_NOIMP ) && !xIS_SET( obj->in_room->room_flags, ROOM_NOIMP ) )
               {
                  sprintf( buf2, "&z[****] IMP Log: &b%s&D", obj->short_descr );
                  log_string( buf2 );
/*
				if ( xIS_SET(obj->extra_flags, ITEM_NOIMP) )
					continue;
*/
                  for( pch = first_char; pch; pch = pch->next )
                  {
                     if( !IS_NPC( pch )
                         && IS_AWAKE( pch ) && pch->in_room && pch->in_room->area == pArea && pch->in_room == obj->in_room )
                     {
                        sprintf( buf, "An imp grabs %s and dissapears.\n\r", obj->short_descr );
                        send_to_char( buf, pch );
                     }
                  }
                  //separate_obj( obj );
      ...
      if( pArea->nplayer == 0 || pArea->age >= reset_age )
      {
         ...
         fprintf( stderr, "%s :: Resetting: %s\n", strtime, pArea->filename );
         reset_area( pArea );
         if( reset_age == -1 )
            pArea->age = -1;
         else
            pArea->age = number_range( 0, reset_age / 5 );
         pRoomIndex = get_room_index( ROOM_VNUM_SCHOOL_ADV );
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA * pMobIndex )
{
   ...
   if( pMobIndex->level < 100 )
   {
      mob->max_hit = pMobIndex->level * 15;
   }
   else
   {
      mob->max_hit = pMobIndex->level * 150;
   }
   mob->hit = mob->max_hit;
//    mob->gold         = pMobIndex->gold;
   mob->exp = pMobIndex->exp;
   mob->exptier = pMobIndex->exptier;
   mob->position = pMobIndex->position;
   mob->defposition = pMobIndex->defposition;
/*	if ( pMobIndex->level < 100 )
	{
		mob->barenumdie		= URANGE( 0, pMobIndex->level/4, 10 );
		mob->baresizedie		= URANGE( 0, pMobIndex->level/4, 10 );
		mob->mobthac0		= URANGE( 0, pMobIndex->level/2, 10 );
		mob->hitplus		= URANGE( 0, pMobIndex->level/4, 10 );
		mob->damplus		= URANGE( 0, pMobIndex->level/4, 10 );
	}
	else
	{
...
// }
   ...
   if( pMobIndex->hitroll == pMobIndex->level / 2 )
   {
      mob->hitroll = pMobIndex->hitroll;
   }
   else
   {
      mob->hitroll = pMobIndex->level / 2;
   }
   if( pMobIndex->damroll == pMobIndex->level / 2 )
   {
   ...
   if( mob->race == 0 || mob->race == 1 || mob->race == 2 ||
       mob->race == 3 || mob->race == 4 || mob->race == 5 ||
       mob->race == 6 || mob->race == 7 || mob->race == 8 || mob->race == 9 || mob->race == 10 )
   {
      mob->gold = ( ( mob->level * 3 ) / 2 );
   }
   else if( IS_SHOP( mob ) )
   {
      mob->gold = 999999999;
...
void clear_char( CHAR_DATA * ch )
{
   ...
   ch->inter_type = NO_TYPE;
   ch->inter_editing = NULL;
   ch->inter_editing_vnum = -1;
...
void free_char( CHAR_DATA * ch )
{
   ...
   if( ch->pcdata )
   {
      ...
      if( ch->pcdata->rreply )
         DISPOSE( ch->pcdata->rreply );
      if( ch->pcdata->rreply_name )
         DISPOSE( ch->pcdata->rreply_name );
...
void log_string_plus( const char *str, sh_int log_type, sh_int level )
{
   ...
   {
      default:
         to_channel( str + offset, CHANNEL_LOG, "Log", sysdata.log_level, level );
         break;
      case LOG_BUILD:
         to_channel( str + offset, CHANNEL_BUILD, "Build", sysdata.log_level, level );
         break;
      case LOG_COMM:
         to_channel( str + offset, CHANNEL_COMM, "Comm", sysdata.log_level, level );
         break;
      case LOG_WARN:
         to_channel( str + offset, CHANNEL_WARN, "Warn", sysdata.log_level, level );
         break;
      case LOG_ALL:
         break;
   }
...
/*          word = feof( gfp ) ? "End" : fread_word( gfp );
   ...
   unlink( WIZLIST_FILE );
   sprintf( buf, "&WImmortals of &c%s&W!&Y", sysdata.mud_name );
   towizfile( buf );
   buf[0] = '\0';
   ilevel = 65535;
   for( wiz = first_wiz; wiz; wiz = wiz->next )
   {
      if( wiz->level < ilevel )
      {
         ...
         {
            case MAX_LEVEL - 0:
               towizfile( " &RHost Admins&Y" );
               break;
            case MAX_LEVEL - 10:
               towizfile( " &RHost Seniors&Y" );
               break;
            case MAX_LEVEL - 20:
               towizfile( " &RHosts&Y" );
               break;
            case MAX_LEVEL - 30:
               towizfile( " &RHigh Templars (Senior Coder)&Y" );
               break;
            case MAX_LEVEL - 40:
               towizfile( " &RArch Templars&Y" );
               break;
            case MAX_LEVEL - 50:
               towizfile( " &RTemplars&Y" );
               break;
            case MAX_LEVEL - 60:
               towizfile( " &RElder Wizards (Builders)&Y" );
               break;
            case MAX_LEVEL - 70:
               towizfile( " &RArch Wizards (Builders)&Y" );
               break;
            case MAX_LEVEL - 80:
               towizfile( " &RWizards (Builders)&Y" );
               break;
            case MAX_LEVEL - 90:
               towizfile( " &RGrand Bishops (Helps)&Y" );
               break;
            case MAX_LEVEL - 100:
               towizfile( " &RArch Bishops (Head PR)&Y" );
               break;
            case MAX_LEVEL - 110:
               towizfile( " &RBishops (Public Relations)&Y" );
               break;
            case MAX_LEVEL - 120:
               towizfile( " &RGrand Lords (Socials)&Y" );
               break;
            case MAX_LEVEL - 130:
               towizfile( " &RLords (Registrants)&Y" );
               break;
            case MAX_LEVEL - 140:
               towizfile( " &RArch Dukes (Quest)&Y" );
               break;
            case MAX_LEVEL - 150:
               towizfile( " &RDukes (Ideas)&Y" );
               break;
            case MAX_LEVEL - 160:
               towizfile( " &RArch Druids (Deities)&Y" );
               break;
            case MAX_LEVEL - 170:
               towizfile( " &RDruids (Starting)&Y" );
               break;
            case MAX_LEVEL - 180:
               towizfile( " &RArch Angels&Y" );
               break;
            case MAX_LEVEL - 190:
               towizfile( " &RAngels&Y" );
               break;
            case MAX_LEVEL - 200:
               towizfile( " &RRetired&Y" );
               break;
            default:
               towizfile( " Servants" );
               break;
...
MOB_INDEX_DATA *make_mobile( int vnum, int cvnum, char *name )
{
   ...
   if( !cMobIndex )
   {
      ...
      xSET_BIT( pMobIndex->act, ACT_IS_NPC );
      xSET_BIT( pMobIndex->act, ACT_STAY_AREA );
   ...
   else
   {
      ...
      pMobIndex->exptier = cMobIndex->exptier;
...
void show_vnums( CHAR_DATA * ch, int low, int high, bool proto, bool shownl, char *loadst, char *notloadst )
{
   ...
   for( pArea = first_sort; pArea; pArea = pArea->next_sort )
   {
      ...
      if( IS_SET( pArea->status, AREA_LOADED ) )
         ...
         continue;
      pager_printf( ch, "&W%-15s&p| &zRooms&p: &W%5d &p- &W%-5d"
                    " &zObjs&p: &W%5d &p- &W%-5d &zMobs&p: &W%5d &p- &W%-5d&P%s\n\r",
   ...
   pager_printf( ch, "&RAreas listed: &Y%d  &RLoaded: &Y%d&D\n\r", count, loaded );
   return;
}
...
void do_vnums( CHAR_DATA * ch, char *argument )
{
   ...
   show_vnums( ch, low, high, TRUE, TRUE, " *&D", "&D" );
}
...
void do_zones( CHAR_DATA * ch, char *argument )
{
   ...
   show_vnums( ch, low, high, FALSE, TRUE, "&D", " X&D" );
}
...
void save_sysdata( SYSTEM_DATA sys )
{
   ...
   else
   {
      ...
      fprintf( fp, "Dmud         %d\n", sys.dmud );
      fprintf( fp, "Debug        %d\n", sys.debug );
      fprintf( fp, "Manualb          %d\n", sys.manualb );
      fprintf( fp, "Warmboot          %d\n", sys.warmboot );
      fprintf( fp, "Salltime %s~\n", sys.salltime );
      fprintf( fp, "Cver          %d\n", sys.cver );
      fprintf( fp, "TransLock          %d\n", sys.trans_lock );
      fprintf( fp, "FightLock          %d\n", sys.fight_lock );
      fprintf( fp, "SpellLock          %d\n", sys.spell_lock );
      fprintf( fp, "PKillLock          %d\n", sys.pkill_lock );
      fprintf( fp, "MaxGlory          %d\n", sys.max_glory );
      fprintf( fp, "Build          %d\n", sys.build_level );
      fprintf( fp, "Log            %d\n", sys.log_level );
      fprintf( fp, "Protoflag      %d\n", sys.level_modify_proto );
      fprintf( fp, "Overridepriv   %d\n", sys.level_override_private );
      fprintf( fp, "MsetAuto     %d\n", sys.mset_auto );
   ...
   for( ;; )
   {
      ...
      switch ( UPPER( word[0] ) )
      {
         ...
         case 'B':
            ...
            KEY( "Bsql", sys->bsql, fread_number( fp ) );
            break;

         case 'C':
            KEY( "CheckImmHost", sys->check_imm_host, fread_number( fp ) );
            KEY( "Cver", sys->cver, fread_number( fp ) );
            break;
         ...
         case 'D':
            ...
            KEY( "Dsq", sys->dsq, fread_number( fp ) );
            KEY( "Dmud", sys->dmud, fread_number( fp ) );
            break;

         case 'E':
            KEY( "Exp1", sys->exp1, fread_number( fp ) );
            KEY( "Exp2", sys->exp2, fread_number( fp ) );
            KEY( "Exp3", sys->exp3, fread_number( fp ) );
            KEY( "Exp4", sys->exp4, fread_number( fp ) );
            KEY( "Exp5", sys->exp5, fread_number( fp ) );
            KEY( "Exp6", sys->exp6, fread_number( fp ) );
            KEY( "Exp7", sys->exp7, fread_number( fp ) );
            KEY( "Exp8", sys->exp8, fread_number( fp ) );
            KEY( "Exp9", sys->exp9, fread_number( fp ) );
            if( !str_cmp( word, "End" ) )
            {
               if( !sys->time_of_max )
         ...
         case 'F':
            KEY( "FightLock", sys->fight_lock, fread_number( fp ) );
         ...
         case 'I':
            ...
            KEY( "ImmuneIdle", sys->immune_to_idle, fread_number( fp ) );
            KEY( "IMCMailVnum", sys->imc_mail_vnum, fread_number( fp ) );
            KEY( "Imp", sys->imp, fread_number( fp ) );
            KEY( "Impmsg", sys->impmsg, fread_string( fp ) );
            break;

         case 'K':
            KEY( "Kaura", sys->kaura, fread_number( fp ) );
            break;
         case 'L':
            KEY( "LastCommand", sys->lastcommand, fread_string( fp ) );
            KEY( "Log", sys->log_level, fread_number( fp ) );
            break;

         case 'M':
            KEY( "Manualb", sys->manualb, fread_number( fp ) );
            KEY( "MorphOpt", sys->morph_opt, fread_number( fp ) );
            KEY( "MsetAuto", sys->mset_auto, fread_number( fp ) );
            ...
            KEY( "MaxHP", sys->max_hp, fread_number( fp ) );
            KEY( "MaxMana", sys->max_mana, fread_number( fp ) );
            KEY( "MaxMove", sys->max_move, fread_number( fp ) );
            KEY( "MaxPrac", sys->max_prac, fread_number( fp ) );
            KEY( "MaxGlory", sys->max_glory, fread_number( fp ) );
            break;
         ...
         case 'P':
            ...
            KEY( "PKillLock", sys->pkill_lock, fread_number( fp ) );
            KEY( "Pkloot", sys->pk_loot, fread_number( fp ) );
            KEY( "Protoflag", sys->level_modify_proto, fread_number( fp ) );
            KEY( "Profanity", sys->profanityfilter, fread_number( fp ) );
            break;
         ...
         case 'W':
            ...
            KEY( "Warmboot", sys->warmboot, fread_number( fp ) );
