...
char *const sec_flags[] = {
   ...
   "underground", "ruins", "lava", "swamp", "r1", "r2", "r3", "r4", "r5", "r6", "r7",
...
char *const r_flags[] = {
   ...
   "donation", "nodropall", "silence", "logspeech", "nodrop", "bloodroom",
   "nosummon", "noastral", "teleport", "clanstoreroom", "nofloor",
   "nosupplicate", "arena", "nomissile", "prototype", "dnd",
   "noteleport", "noportal", "bank", "nohome", "noshift", "nosleep", "noimp",
   "hadnd", "safety", "forge", "nosanc", "norecallset", "notap", "bm", "r1", "r2"
};
...
char *const o_flags[] = {
   ...
   "donated", "clanobject", "clancorpse", "antivampire", "antidruid",
   "hidden", "poisoned", "covering", "deathrot", "buried", "prototype",
   "nolocate", "groundrot", "lootable", "antimale", "antifemale", "antiranger",
   "noscrap", "antibarbarian", "antisorcerer", "antipaladin", "noimp", "lodged",
   "sharpened", "antiarcher", "antijedika", "antiwerewolf", "jedikaonly", "archeronly",
   "antitaedien", "nodualw", "owned", "nopurge", "twohanded", "samuraionly", "rare",
   "darkened", "silver", "questownpick"
};
...
char *const w_flags[] = {
   ...
   "missile", "back", "face", "ankle", "float", "clan", "lodge_rib", "lodge_arm", "lodge_leg",
   "r9", "r10", "r11", "r12", "r13"
};
...
char *const item_w_flags[] = {
   ...
   "float", "clan", "lodge_rib", "lodge_arm", "lodge_leg", "r9", "r10", "r11", "r12", "r13"
};

char *const area_flags[] = {
   "nopkill", "freekill", "noteleport", "spelllimit", "sleepdam", "r5", "r6", "r7", "r8",
...
char *const o_types[] = {
   ...
   "container", "_note", "drinkcon", "key", "food", "katyr", "pen", "boat",
   ...
   "fuel", "piece", "ghost", "missileweapon", "projectile", "quiver", "shovel",
   "salve", "cook", "keyring", "odor", "window", "tool", "siam", "rona",
   "flute", "ore", "keyitem", "chance"
};

char *const a_types[] = {
   "none", "strength", "dexterity", "intelligence", "wisdom", "constitution",
   "sex", "class", "level", "age", "height", "weight", "mana", "hit", "move",
   "katyr", "experience", "armor", "hitroll", "damroll", "save_poison", "save_rod",
   ...
   "grip", "scribe", "brew", "wearspell", "removespell",
   "stripsn", "remove", "dig", "full", "thirst", "drunk", "blood", "cook",
   "recurringspell", "contagious", "xaffected", "odor", "roomflag", "sectortype",
   "roomlight", "televnum", "teledelay", "siam", "rona"
};

char *const a_flags[] = {
   "blind", "invisible", "detect_evil", "detect_invis", "detect_magic",
   "detect_hidden", "hold", "sanctuary", "faerie_fire", "infrared", "curse",
   "move_hidden", "poison", "protect", "_paralysis", "sneak", "hide", "sleep",
   "charm", "flying", "pass_door", "floating", "true_sight", "detect traps",
   "scrying", "fireshield", "shockshield", "improved_invis", "iceshield", "alertness",
   "berserk", "aqua_breath", "invincibility", "ironskin", "godspell", "holyaura", "possess",
   "tricked", "regeneration", "barkskin", "demonfire", "contraceptive", "delirium",
   "steel_skin", "jer", "hades_armor", "armor", "jir", "purity", "jur", "headache", "blackflame",
   "dangle", "gob_bless", "frenzy", "holysight", "quickness", "battle_plan", "biofeedback",
   "displacement", "calcify_flesh", "plague", "shield", "ironhand", "stormshift", "karaaura",
   "demi",
   "recurringspell", "contagious", "acidmist", "venomshield", "r1"
};

char *const act_flags[] = {
   "npc", "sentinel", "scavenger", "blocker", "undertaker", "aggressive", "stayarea",
   "wimpy", "pet", "train", "practice", "immortal", "deadly", "shop",
   "innkeeper", "guardian", "running", "nowander", "mountable", "mounted",
   "dragoon", "secretive", "nopurge", "mobinvis", "noassist", "autonomous",
   "pacifist", "noattack", "annoying", "statshield", "prototype", "registrar"
};

char *const pc_flags[] = {
   "r1", "deadly", "unauthed", "norecall", "nointro", "gag", "retired", "guest",
   "nosummon", "pager", "notitled", "groupwho", "diagnose", "highgag", "",
   "nstart", "dnd", "flags", "sector", "aname", "filename", "nobeep", "privacy", "position", "experienced",
   "building", "nobattlespam", "immalt", "nopretitle", "r23", "r24", "r25"
};
...
char *const plr_flags[] = {
   ...
   "flee", "autokatyr", "automap", "afk", "invisprompt", "iaw", "shortscore",
   "scoreaffects", "autotitle", "compass", "questing", "condition", "pingme",
   "affsaves", "midscore", "deaf", "iddling", "tied-up", "gagged", "blindfolded",
   "eexp", "edone", "pregnant", "bountied", "statboosted", "track"
};
...
char *const ris_flags[] = {
   ...
   "plus3", "plus4", "plus5", "plus6", "magic", "paralysis", "hack", "lash", "psionic",
...
void do_goto( CHAR_DATA * ch, char *argument )
{
   ...
   ROOM_INDEX_DATA *location, *in_room, *temp;
   ...
   if( !is_number( arg ) && ( fch = get_char_world( ch, arg ) ) )
   {
      if( ( !IS_NPC( fch ) && get_trust( ch ) < get_trust( fch ) && IS_SET( fch->pcdata->flags, PCFLAG_DND ) )
          || ( xIS_SET( fch->in_room->room_flags, ROOM_DND )
               || ( xIS_SET( fch->in_room->room_flags, ROOM_HADND ) && ch->level < 1000 ) ) )
      {
   ...
   if( ( location = find_location( ch, arg ) ) == NULL )
   {
      ...
      if( get_trust( ch ) < LEVEL_BUILD || vnum < 1 || IS_NPC( ch ) || !ch->pcdata->area )
      {
         send_to_char( "No such location.\n\r", ch );
         return;
      }
/*      if ( xIS_SET(location->room_flags, ROOM_DND)
	  || ( xIS_SET(location->room_flags, ROOM_HADND) && ch->level < 1000 ) )
      {
         pager_printf( ch,  
      ...
      if( xvnum != 0 )
      {
         for( x = vnum; x <= xvnum; x++ )
         {
            temp = make_room( x );
            temp->area = ch->pcdata->area;
            ch_printf( ch, "Room %d made.\n\r", x );
         }
         location = get_room_index( xvnum );
      }
      else
      {
   ...
   {
      if( ( get_trust( ch ) < sysdata.level_override_private ) /*|| !IS_ANGEL(ch) */  )
      {
   ...
   for( vch = first_char; vch; vch = vch_next )
   {
      ...
      if( !IS_NPC( vch ) && vch->in_room == in_room && vch != ch )
      {
         if( ( can_see( vch, ch ) && IS_IMMORTAL( vch ) ) || ( !xIS_SET( ch->act, PLR_WIZINVIS ) && !IS_IMMORTAL( vch ) ) )
         {
            act( AT_IMMORT, "$T", vch, NULL, ( ch->pcdata && ch->pcdata->bamfout[0] != '\0' ) ? ch->pcdata->bamfout : bam2,
                 TO_CHAR );
         }
      }
   }
   ...
   for( vch = first_char; vch; vch = vch_next )
   {
      ...
      if( !IS_NPC( vch ) && vch->in_room == location && vch != ch )
      {
         if( ( can_see( vch, ch ) && IS_IMMORTAL( vch ) ) || ( !xIS_SET( ch->act, PLR_WIZINVIS ) && !IS_IMMORTAL( vch ) ) )
         {
            act( AT_IMMORT, "$T", vch, NULL, ( ch->pcdata && ch->pcdata->bamfin[0] != '\0' ) ? ch->pcdata->bamfin : bam,
                 TO_CHAR );
         }
      }
   }
...
void do_mset( CHAR_DATA * ch, char *argument )
{
   ...
   if( ch->substate == SUB_REPEATCMD )
   {
      ...
      if( !str_cmp( argument, "done" ) || !str_cmp( argument, "off" ) )
      {
         ...
         ch->substate = SUB_NONE;
         ch->dest_buf = NULL;
         xREMOVE_BIT( ch->in_room->room_flags, ROOM_SAFE );
   ...
   if( arg1[0] == '\0' || ( arg2[0] == '\0' && ch->substate != SUB_REPEATCMD ) || !str_cmp( arg1, "?" ) )
   {
      ...
      send_to_char( "  str int wis dex con cha lck sex class dualclass\n\r", ch );
      send_to_char( "  hp mana move practice align race\n\r", ch );
      send_to_char( "  katyr siam rona\n\r", ch );
      send_to_char( "  hitroll damroll armor affected level sublevel recall\n\r", ch );
      send_to_char( "  thirst drunk full blood flags exptier\n\r", ch );
      ...
      send_to_char( "  name short long desc title movein moveout spec\n\r", ch );   // clan clanrank
   ...
   if( get_trust( ch ) < LEVEL_BUILD && IS_NPC( victim ) && xIS_SET( victim->act, ACT_STATSHIELD ) )
   {
      send_to_char( "You can't do that!\n\r", ch );
      ch->dest_buf = NULL;
      return;
   ...
   if( IS_NPC( victim ) || IS_AGOD( victim ) )
   {
      minattr = 1;
      maxattr = 25;
   }
   ...
   if( !str_cmp( arg2, "on" ) )
   {
      ...
      ch->dest_buf = victim;
      xSET_BIT( ch->in_room->room_flags, ROOM_SAFE );
      if( ch->pcdata )
      {
   ...
   if( !str_cmp( arg2, "exptier" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 0 || value > 5 )
      {
         ch_printf( ch, "ExpTier range is 0 to 5.\n\r" );
         return;
      }
      victim->exptier = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
         victim->pIndexData->exptier = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "sex" ) )
   {
      ...
      if( value < 0 || value > 1 )
      {
         send_to_char( "Sex range is 0 to 1.\n\r", ch );
         return;
      }
      victim->sex = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
   ...
   if( !str_cmp( arg2, "dualclass" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( IS_NPC( victim ) )
      {
         send_to_char( "You cannot set dualclass on NPC's", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "wizshow" ) )
   {
      ...
      if( IS_NPC( victim ) )
      {
         send_to_char( "You cannot set wizshow on NPC's", ch );
         return;
      }
      if( !IS_IMMORTAL( victim ) )
      {
         ch_printf( ch, "Can only be done on immortals.\n\r" );
         return;
      }
      victim->pcdata->wizshow = value;
   ...
   if( !str_cmp( arg2, "armor" ) )
   {
      ...
      {
         send_to_char( "AC range is -1000 to 1000.\n\r", ch );
         return;
      }
      victim->armor = value;
      if( IS_NPC( victim ) && xIS_SET( victim->act, ACT_PROTOTYPE ) )
   ...
   if( !str_cmp( arg2, "level" ) )
   {
      ...
      if( value < 0 || value > MAX_LEVEL - 200 )
      {
   ...
   if( !str_cmp( arg2, "katyr" ) )
   {
      ...
      if( !IS_NPC( victim ) )
      {
         if( value > MAX_GOLD )
         {
            send_to_char( "Maximum katyr is 99,999,999 katyr.\n\r", ch );
            return;
         }
         else
         {
   ...
   if( !str_cmp( arg2, "recall" ) )
   {
      ...
      if( ( get_room_index( value ) ) == NULL )
         ch_printf( ch, "%d invalid room!", value );
      else
         ch->pcdata->recall = UMIN( 0, value );
      return;
   }
   ...
   if( !str_cmp( arg2, "hp" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 1 || value > sysdata.max_hp )
      {
   ...
   if( !str_cmp( arg2, "mana" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 0 || value > sysdata.max_mana )
      {
   ...
   if( !str_cmp( arg2, "blood" ) )
   {
      ...
      if( value < 0 || value > sysdata.max_mana )
      {
         ch_printf( ch, "Blood range is 0 to %d blood points.\n\r", sysdata.max_mana );
         return;
      }
   ...
   if( !str_cmp( arg2, "move" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 0 || value > sysdata.max_move )
      {
         ch_printf( ch, "Mana range is 0 to %d move points.\n\r", sysdata.max_move );
         return;
      }
   ...
   if( !str_cmp( arg2, "practice" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( value < 0 || value > sysdata.max_prac )
      {
         ch_printf( ch, "Mana range is 0 to %d mana points.\n\r", sysdata.max_prac );
         return;
      }
   ...
   if( !str_cmp( arg2, "rank" ) )
   {
      ...
      if( !argument || argument[0] == '\0' || !str_cmp( argument, "none" ) )
         ...
         victim->pcdata->rank = atoi( argument );
      send_to_char( "Ok.\n\r", ch );
      return;
   }
   ...
   if( !str_cmp( arg2, "qp" ) )
   {
      ...
      if( value < 0 || value > sysdata.max_glory )
      {
         ch_printf( ch, "The current quest point range is 0 to %d.\n\r", sysdata.max_glory );
         return;
      }
   ...
   if( !str_cmp( arg2, "name" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_HEADBUILD )
      {
         send_to_char( "Not on PC's.\n\r", ch );
         return;
      }
   ...
   if( !str_cmp( arg2, "clanrank" ) )
   {
      ...
      if( arg3[0] == '\0' )
      {
         send_to_char( "member, leader, one or two?", ch );
         return;
      }

      if( !str_cmp( arg3, "member" ) )
      {
         victim->pcdata->rank = clan->memrank;
         send_to_char( "Done.", ch );
         return;
      }
      if( !str_cmp( arg3, "leader" ) )
      {
         victim->pcdata->rank = clan->leadrank;
         send_to_char( "Done.", ch );
         return;
      }
      if( !str_cmp( arg3, "one" ) )
      {
         victim->pcdata->rank = clan->onerank;
         send_to_char( "Done.", ch );
         return;
      }
      if( !str_cmp( arg3, "two" ) )
      {
         victim->pcdata->rank = clan->tworank;
         send_to_char( "Done.", ch );
         return;
      }
   }

   if( !str_cmp( arg2, "clanc" ) )
   {
      if( !can_mmodify( ch, victim ) )
         return;
      ...
      if( value > 1 )
      {
         send_to_char( "Number range of 0 or 1 please.", ch );
         return;
      }

      victim->pcdata->clan_c = value;
      return;
   }
   ...
   if( !str_cmp( arg2, "movein" ) )
   {
      ...
      set_movein( victim, arg3 );
      return;
   }

   if( !str_cmp( arg2, "moveout" ) )
   {
      if( IS_NPC( victim ) )
      {
         send_to_char( "Not on NPC's.\n\r", ch );
   ...
   {
      bool pcflag;
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_CODER )
      {
      ...
      while( argument[0] != '\0' )
      {
         ...
         else
         {
            if( IS_NPC( victim )
                && value == ACT_PROTOTYPE
                && get_trust( ch ) < LEVEL_BUILD && !is_name( "protoflag", ch->pcdata->bestowments ) )
   ...
   {
      if( !IS_NPC( victim ) && get_trust( ch ) < LEVEL_BUILD )
      {
         send_to_char( "You can only modify a mobile's flags.\n\r", ch );
         return;
      }
...
void do_oset( CHAR_DATA * ch, char *argument )
{
   ...
   if( arg1[0] == '\0' || arg2[0] == '\0' || !str_cmp( arg1, "?" ) )
   {
      ...
      send_to_char( "  name short long desc rmdesc actiondesc\n\r", ch );
      send_to_char( "  type value0 value1 value2 value3 value4 value5 value6 value7\n\r", ch );
      send_to_char( "  affect rmaffect layers owner\n\r", ch );
   ...
   {
      if( !str_cmp( arg3, "none" ) && ( obj->owner && obj->owner != '\0' ) )
      {
         STRFREE( obj->owner );
         if( IS_OBJ_STAT( obj, ITEM_OWNED ) )
         {
            xREMOVE_BIT( obj->extra_flags, ITEM_OWNED );
         }
         return;
      }
      STRFREE( obj->owner );
   ...
   if( !str_cmp( arg2, "desc" ) )
   {
      if( !arg3 || arg3[0] == '\0' )
      {
         send_to_char( "Syntax: oset <object> desc <keywords>\n\r", ch );
         return;
      }
      CHECK_SUBRESTRICTED( ch );
      if( obj->timer )
      ...
      if( obj->item_type == ITEM_PAPER && get_trust( ch ) < LEVEL_ADMINADVISOR )
      {
   ...
   if( !str_cmp( arg2, "rmdesc" ) )
   {
      if( !arg3 || arg3[0] == '\0' )
      {
         send_to_char( "Syntax: oset <object> rmdesc <keywords>\n\r", ch );
         return;
      }
      if( IS_OBJ_STAT( obj, ITEM_PROTOTYPE ) )
      {
   ...
   if( !str_cmp( arg, "flags" ) )
   {
      ...
      while( argument[0] != '\0' )
      {
         ...
         else
         {
            ...
            if( 1 << value == ROOM_PROTOTYPE && get_trust( ch ) < LEVEL_BUILD )
            {
               send_to_char( "You cannot change the prototype flag.\n\r", ch );
               return;
            }
...
void do_ocreate( CHAR_DATA * ch, char *argument )
{
   ...
   if( cvnum != 0 )
   {
      ...
      if( argument[0] == '\0' )
      {
         send_to_char( "You must state one keyword.\n\r", ch );
         return;
      }
   }
   if( cvnum < 1 )
   ...
   if( sysdata.mset_auto == 1 )
   {
      sprintf( buf, "%d on", vnum );
      ch->last_cmd = do_oset;
      do_oset( ch, buf );
   }
}
...
void do_mcreate( CHAR_DATA * ch, char *argument )
{
   ...
   if( cvnum != 0 )
   {
      ...
      if( argument[0] == '\0' )
      {
         send_to_char( "You must state a keyword.\n\r", ch );
         return;
      }
   }
   if( cvnum < 1 )
...
void edit_buffer( CHAR_DATA * ch, char *argument )
{
   ...
   if( argument[0] == '/' || argument[0] == '\\' )
   {
      ...
      if( !str_cmp( cmd + 1, "r" ) )
      {
         ...
         {
            ch_printf( ch, "Need word to replace, and replacement.\n\r%d> ", edit->on_line + 1 );
            return;
         }
   ...
   else
   {
      if( strlen( argument ) > 79 )
      {
         ...
         buf[79] = 0;
         ch_printf( ch, "(Long line trimmed)\n\r%d> ", edit->on_line + 1 );
      }
      else
         strcpy( buf, argument );
...
// char buf3[MAX_STRING_LENGTH];
   ...
   if( get_trust( ch ) > LEVEL_IMMORTAL && ch->pcdata->r_range_lo && ch->pcdata->r_range_hi )
   {
      ...
      if( !tarea )
      {
         ...
         sprintf( buf, "{PROTO} %s's area", ch->name );
...
void do_aassign( CHAR_DATA * ch, char *argument )
{
   ...
   if( get_trust( ch ) >= LEVEL_ADVBUILD
...
void fold_area( AREA_DATA * tarea, char *filename, bool install )
{
   ...
   log_string_plus( buf, LOG_NORMAL, LEVEL_BUILD );
...
void do_savearea( CHAR_DATA * ch, char *argument )
{
   ...
   if( IS_NPC( ch ) || get_trust( ch ) < LEVEL_BUILD || !ch->pcdata || ( argument[0] == '\0' && !ch->pcdata->area ) )
   {
   ...
   for( tarea = first_build; tarea; tarea = tarea->next )
   {
      if( !str_cmp( tarea->filename, arg ) )
      {
         if( argument && argument[0] != '\0' )
         {
            ...
            {
               send_to_char( "Shorter name please.\n\r", ch );
               return;
            }
            DISPOSE( tarea->name );
...
void do_astat( CHAR_DATA * ch, char *argument )
{
   ...
   switch ( tarea->plane )
   {
      default:
         break;
      case 1:
         sprintf( pname, "1, Terra" );
         break;
      case 2:
         sprintf( pname, "2, White" );
         break;
      case 3:
         sprintf( pname, "3, Lorur" );
         break;
      case 4:
         sprintf( pname, "4, Ophelia" );
         break;
      case 5:
         sprintf( pname, "5, Utopia" );
         break;
      case 6:
         sprintf( pname, "6, All" );
         break;
      case 7:
         sprintf( pname, "7, Angel" );
         break;
   }

   ch_printf_color( ch,
                    "\n\r&wName:     &W%s\n\r&wFilename: &W%-20s  &wPrototype: &W%s\n\r&wAuthor:   &W%-20s   &wPlane: &W%s\n\r",
                    tarea->name, tarea->filename, proto ? "yes" : "no", tarea->author, pname );
   ...
   if( !proto )
   {
      ...
      ch_printf_color( ch, "&YKatyr Looted:  &W%d\n\r", tarea->gold_looted );
   ...
   ch_printf_color( ch, "&wResetmsg: &W%s\n\r", tarea->resetmsg ? tarea->resetmsg : "(default)" );
...
void do_aset( CHAR_DATA * ch, char *argument )
{
   ...
   if( arg1[0] == '\0' || arg2[0] == '\0' )
   {
      ...
      send_to_char( "  author resetmsg resetfreq flags plane\n\r", ch );
      return;
   }
...
void do_rlist( CHAR_DATA * ch, char *argument )
{
   ...
   if( IS_NPC( ch ) || get_trust( ch ) < LEVEL_BUILD || !ch->pcdata
       || ( !ch->pcdata->area && get_trust( ch ) < LEVEL_BUILD ) )
   {
   ...
   if( tarea )
   {
      ...
      if( ( lrange < tarea->low_r_vnum || trange > tarea->hi_r_vnum ) && get_trust( ch ) < LEVEL_BUILD )
      {
...
void do_olist( CHAR_DATA * ch, char *argument )
{
   ...
   if( tarea )
   {
      ...
      if( ( lrange < tarea->low_o_vnum || trange > tarea->hi_o_vnum ) && get_trust( ch ) < LEVEL_BUILD )
      {
         send_to_char_color( "&YThat is out of your vnum range.\n\r", ch );
         return;
      }
   ...
   if( trange - lrange > 1000 )
   {
      send_to_char_color( "&YKeep the range to a thousand please.\n\r", ch );
      return;
   }
   pager_printf( ch, "&RObjects for vnum range: &w%d &W%d\n\r", lrange, trange );
   ...
   for( vnum = lrange; vnum <= trange; vnum++ )
   {
      ...
      if( IS_OBJ_STAT( obj, ITEM_PROTOTYPE ) )
         ...
         pro = "NP";
      pager_printf( ch, "&G%5d &P[&p%-2s&P] &C<&c%4d&C>&g %-20s &G(&g%s&G)&D\n\r",
                    vnum, pro, obj->value[7], obj->name, obj->short_descr );
   }
   return;
}
...
void do_mlist( CHAR_DATA * ch, char *argument )
{
   ...
   if( tarea )
   {
      ...
      if( ( lrange < tarea->low_m_vnum || trange > tarea->hi_m_vnum ) && get_trust( ch ) < LEVEL_BUILD )
      {
         send_to_char_color( "&YThat is out of your vnum range.\n\r", ch );
         return;
      }
   ...
   pager_printf( ch, "&RMobiles for vnum range: &w%d &W%d\n\r", lrange, trange );
   ...
   for( vnum = lrange; vnum <= trange; vnum++ )
   {
      ...
      pager_printf( ch, "&G%5d &P[&p%-2s&P] &R%d &C<&c%4d&C>&g %-20s &G(&g%s&G)&D\n\r",
                    vnum,
                    xIS_SET( mob->act, ACT_PROTOTYPE ) ? "P" : "NP",
                    mob->exptier, mob->level, mob->player_name, mob->short_descr );
   }
   return;
}
